    ...
    <div x-data="{ open: false }" class="flex h-screen overflow-x-hidden">
        <aside class="flex h-screen w-64 flex-shrink-0 flex-col transition-all duration-300">
            ...
            <nav
                ...
                <a href="#" class="flex items-center w-full px-8 py-3 hover:bg-blue-400 hover:text-white "
                    @click="open = !open">
                    <span class="material-icons" style="font-size: 25px;"> donut_small </span> <span
                        class=" ml-9">multilevel side
                        bar</span> <span class="ml-auto"> <span x-show="!open" class="material-icons"
                ...
                <a href="#" class="flex items-center w-full px-8 py-3 hover:bg-blue-400 hover:text-white text-black">
                    ...
                    <span class="ml-9">Test 3</span>
                </a>
                <a href="#" class="flex items-center w-full px-8 py-3 hover:bg-blue-400 hover:text-white text-black">
                    <span class="material-icons md-36" style="font-size: 25px;">
                        settings
                    </span>
                    <span class="ml-9">Test 4</span>
                </a>
        ...
        <aside class="flex h-screen w-64 flex-shrink-0 flex-col transition-all duration-300">
            ...
            <nav
                ...
                <a href="#" class="flex items-center w-full px-8 py-3 hover:bg-blue-400 hover:text-white ">
                    ...
                    <span class=" ml-9">multilevel side bar</span>
                </a>
