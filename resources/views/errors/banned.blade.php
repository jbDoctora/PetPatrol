    ...
    <div class="flex h-screen overflow-x-hidden">
        ...
        <div class="flex-1 overflow-x-scroll">
            ...
            <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 py-12 sm:px-6 lg:px-8">
                <div class="max-w-3xl w-full bg-white rounded m-5 p-9">
                    ...
                    <p class="mt-2 text-justify text-sm text-gray-600 py-2">
                        Dear {{ auth()->user()->name }},
                    <p class="mt-2 text-justify text-sm text-gray-600 py-2">
                        We regret to inform you that your account has been banned due to multiple reports of violating
                        our community guidelines.
                        We take these reports seriously and have reviewed the evidence to confirm the violation.
                    </p>
                    <p class="mt-2 text-justify text-sm text-gray-600 py-2">
                        However, we understand that mistakes can happen and we want to give you the opportunity to
                        appeal the ban. If you
                        believe that the ban was issued in error, please contact us at <a
                            href="https://mail.google.com/mail/?view=cm&fs=1&to=petpatrol20@gmail.com"
                            class="text-blue-500 underline">petpatrol20@gmail.com</a>
                        with your
                        account information and a brief
                        explanation of why you believe the ban was unwarranted.
                    </p>
                    <p class="mt-2 text-justify text-sm text-gray-600 py-2">
                        Please note that we will review your appeal and respond as soon as possible, but it may take up
                        to 2 business
                        days to fully investigate and make a decision.
                    </p>
                    <p class="mt-2 text-justify text-sm text-gray-600 py-2">
