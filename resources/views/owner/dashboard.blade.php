    ...
    <div class="grid grid-cols-12 gap-6 m-5">
        <div class="col-span-12 md:col-span-8 xl:col-span-9">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mt-6">
                ...
                <div class="bg-gray-200 rounded shadow-md p-6">
                    <div class="text-lg font-medium text-gray-800"><i class="fa-solid fa-calendar-check"></i> Total
                ...
                <div class="bg-gray-200 rounded-lg shadow-md p-6">
                    <div class="text-lg font-medium text-gray-800"><i class="fa-solid fa-calendar-day"></i>Pending
                        Bookings</div>
                    <div class="mt-4 flex items-center justify-between">
