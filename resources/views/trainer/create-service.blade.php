<x-trainer-layout>
    ...
    <div x-data="{ price: '' }">
        <div class="mt-3 grid grid-cols-1 gap-4 px-3 md:grid-cols-2 lg:grid-cols-3">
            @forelse($training as $trainings)
                <div class="mb-4 flex flex-col overflow-hidden rounded-lg bg-white shadow-md">
                    ...
                    <div class="flex justify-end bg-gray-100 p-4">
                        <button class="mr-2 rounded-md bg-blue-500 px-4 py-2 text-white">Create training plan</button>
