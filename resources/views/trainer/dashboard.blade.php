...
<main>
  <div class="drawer">
    ...
    <iframe name="myFrame" src="/trainer/portfolio" frameborder="0" class="w-full h-screen"></iframe>
    </div> 
    <div class="drawer-side">
      ...
      <ul class="menu p-2 w-56 h-screen bg-base-100 text-base-content fixed">
        ...
        <li class="m-4"><a href="/trainer/service/add" target="myFrame"><i class="fa-solid fa-bell-concierge fa-xl"></i>My Service</a></li>
