    ...
    <section class="body-font text-gray-600">
        <div class="container mx-auto px-5 py-24">
            <div class="-m-4 flex flex-wrap">
                ...
                <div class="mt-20 flex w-full flex-wrap mx-16">
                    <div class="mb-6 w-full lg:mb-0 lg:w-1/2">
                        <h1 class="title-font mb-2 text-2xl font-bold text-gray-900 sm:text-3xl">Get pet trainers
                            easily.
                        </h1>
                        <div class="h-1 w-20 rounded bg-indigo-500"></div>
                    </div>
                    <p class="w-full font-bold leading-relaxed text-gray-600 lg:w-1/2 text-justify">In
                        Patrol! Are you a
                        pet owner looking for a skilled and reliable trainer to help your furry friend reach their full
                        potential? Or are you a professional pet trainer seeking new clients in your area? Look no
                        further,
