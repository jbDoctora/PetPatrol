...
<div class="hero min-h-screen" style=" background-image: url(/images/woman-holding-a-dog.png); background-position: right; background-size: contain; background-repeat: no-repeat; object-fit: fill;">
    ...
    <div class="hero-content text-center text-black">
      <div class="max-w-md">
        <h1 class="mb-5 text-6xl font-bold">Take good care of your pets</h1>
        <p class="mb-5 text-1xl">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
        <button class="btn btn-primary"><a href="/book-trainer">Book Appointment</a></button>
      </div>
    </div>
  </div>
