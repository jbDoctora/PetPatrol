...
Route::middleware(['auth', 'isAdmin'])->group(function () {
    ...
    Route::delete('/admin/deleteApplication/{user_id}', [AdminController::class, 'softDeleteApplication']);
});
...
Route::get('/cancellation-policy', [ReportSuggestionsController::class, 'showCancellation']);
